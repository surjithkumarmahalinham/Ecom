@include('header')
    ...
    <table id="cart" class="table table-hover table-condensed">
        ...
        @if(session('cart'))
            @foreach((array) session('cart') as $id => $details)
                ...
                <tr>
                    <td data-th="Product">
                        <div class="row">
                            <div class="col-sm-3 hidden-xs"><img src="{{ URL::asset('assets/images/home/'.$details['image']) }}" width="100" height="100" class="img-responsive"/></div>
                            <div class="col-sm-9">
        ...
        <tr>
            ...
            <input type="radio" name="method" value="Payment">Payment</td></tr>
            <tr>
            <td><input type="submit" name="submit" value="Order Now" class="btn btn-default add-to-cart" style="margin-left: 320px; margin-top: 40px; background-color: orange;"></td>
</form>
